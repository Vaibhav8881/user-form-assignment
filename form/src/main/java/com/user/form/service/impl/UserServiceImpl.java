...
import com.user.form.constants.ApplicationConstants;
...
public class UserServiceImpl implements UserService {
	...
	@Override
	public String saveUserForm(UserDetailsDTO userDetailDTO) {
		UserDetails userDetails = new UserDetails();
		BeanUtils.copyProperties(userDetailDTO, userDetails);
		userRepository.save(userDetails);
		return ApplicationConstants.FORM_SUBMITTED_SUCCESSFULLY;
	}
